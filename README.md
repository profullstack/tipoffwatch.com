...
the account and the code SiriusXM emails them, exactly media-streamer's flow;
only the resulting session is kept — and the sports and news lineups play on `/radio` and on a fixture's page. The
